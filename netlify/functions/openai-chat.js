// Netlify function to proxy OpenAI Chat Completions API
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Add optional organization and project headers if available
    ...
    if (projectId) {
      headers['OpenAI-Project'] = projectId; // switched from X-Project-ID
    }
    ...
    return {
      ...
      body: JSON.stringify({ 
        error: error.message || 'OpenAI proxy failed',
