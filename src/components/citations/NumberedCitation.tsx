// Numbered Citation Component - Shows citation number instead of site name
// Reuses MultipleCitations tooltip structure but displays numbers

import { useState, useRef } from 'react';

interface NumberedCitationProps {
  citations: Array<{
    url: string;
    title: string;
    siteName: string;
  ...
  citationNumber: number; // The display number (1, 2, 3, etc.)
}

export default function NumberedCitation({ citations, citationNumber }: NumberedCitationProps) {
  ...
  return (
    ...
    >
      <button
        ...
        className="inline-flex items-center justify-center w-5 h-5 mx-0.5 text-white text-xs font-bold rounded-full cursor-pointer hover:opacity-90 active:opacity-75 align-super"
        style={{
