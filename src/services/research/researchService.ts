import { ResearchResult, ResearchProgressCallback, InsightProgressCallback } from './types';
...
class ResearchService {
  ...
  performInsightAnalysis(
    ...
    return this.performResearch(query, useProFeatures, onProgress as ResearchProgressCallback);
  }
}
