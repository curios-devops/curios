...
import { LabController } from './agents/controller.ts';
...
export async function generateArtifact(
  ...
  try {
    ...
    const { type = 'doc', isPro = true, onStatusUpdate, onArtifactUpdate } = options; // Studio is always Pro
    ...
    return await handleSupabaseOperation(
      async () => {
        ...
        logger.debug('Studio service received artifact from studio controller', {
    ...
    logger.error('Studio generation error:', {
